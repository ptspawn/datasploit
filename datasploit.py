...
def main(argv):
 ...
 \__,_/ \__,_/ \__/ \__,_//____// .___//_/ \____//_/ \__/
    ...
    parser = argparse.ArgumentParser(formatter_class=argparse.RawDescriptionHelpFormatter,
                                     description=textwrap.dedent(desc), epilog=epilog)
    ...
    parser.add_argument("-q", "--quiet", help="Run scans in automated manner accepting default answers", dest='quiet',
                        action="store_false")
    ...
    if not os.path.exists(config_file_path):
        ...
        print(
            "[+] A config file is added please follow guide at https://datasploit.github.io/datasploit/apiGeneration/ to fill API Keys for better results")
    ...
    if not (single_input or file_input):
        ...
        parser.print_help()
        sys.exit()
    # Banner print(    print textwrap.dedent(desc))
    if single_input:
        try:
